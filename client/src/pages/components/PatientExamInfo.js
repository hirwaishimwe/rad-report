  ...
  return (
    <div className="patient-exam-info">
      <div className="info-section patient-info">
        <h2>Patient Info</h2>
        <p>
          <strong>Patient ID:</strong> {exam.patientId}
        </p>
        <p>
        ...
        <p>
          <strong>BMI:</strong> {exam.bmi}
        </p>
        <p>
          <strong>ZipCode:</strong> {exam.zipCode}
        </p>
      </div>
      <div className="info-section exam-info">
        ...
        <div className="exam-image-container">
          <image src={exam.imageURL} alt="Exam Image" />
        </div>
        <p>
          <strong>Date:</strong> {}
        </p>
        <p>
          <strong>Key Findings:</strong> {exam.keyFindings}
        </p>
        <p>
