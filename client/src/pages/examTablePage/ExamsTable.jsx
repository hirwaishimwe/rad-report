...
function ExamsTable({ exams, isAdmin }) {
  ...
  const handleSort = column => {
    setSortingCriteria(prevCriteria => ({
      column,
      direction:
        prevCriteria.column === column && prevCriteria.direction === "asc"
          ? "desc"
          : "asc",
    }));
  };
            ...
            {exams.map((exam, index) => {
              ...
              return (
                <tr key={_id} className={index % 2 === 0 ? "bg-gray-50" : ""}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">{pro_nouns}</td>
                  <td className="px-6 py-4 whitespace-nowrap">{latest_bmi}</td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    {latest_weight}
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">{zip_code}</td>
                  <td className="px-6 py-4 whitespace-nowrap">{mortality}</td>
                  <td className="px-6 py-4 whitespace-nowrap">{icu_admit}</td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    {icu_admits_count}
                  </td>
                  {isAdmin && (
