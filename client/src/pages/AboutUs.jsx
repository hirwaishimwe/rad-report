        ...
        <div className="about-us-container">
            ...
            <div className="team-members">
                <div className="member">
                    ...
                    <p>Hirwa Ishimwe</p>
                    <a href="mailto:hirwaishimwe2@gmail.com">
                        <AiOutlineMail />
                    </a>
                    <a
                        href="https://www.linkedin.com/in/hirwa-ishimwe"
                        target="_blank"
                ...
                <div className="member">
                    ...
                    <a href="mailto:christopheralphonse96@gmail.com">
                        <AiOutlineMail />
                    </a>
                    <a
                        href="https://www.linkedin.com/in/christopheralphonse/"
                        target="_blank"
                        rel="noopener noreferrer"
                    >
                        <AiFillLinkedin />
                ...
                <div className="member">
                    ...
                    <p>Dimitri Legaspi</p>
                    <a href="mailto:dimitri.legaspi@gmail.com">
                        <AiOutlineMail />
                    </a>
                    <a
                        href="https://www.linkedin.com/in/dimitri-legaspi/"
                        target="_blank"
                        rel="noopener noreferrer"
                    >
                        <AiFillLinkedin />
                ...
                <div className="member">
                    ...
                    <p>Derinell Rojas</p>
                    <a href="mailto:dmrojaa@gmail.com">
                        <AiOutlineMail />
                    </a>
                    <a
                        href="https://www.linkedin.com/in/derinellrojas/"
                        target="_blank"
                        rel="noopener noreferrer"
                    >
                        <AiFillLinkedin />
                ...
                <div className="member">
                    ...
                    <p>Jerison Feliz</p>
                    <a href="mailto:jerisonfeliz15@gmail.com">
                        <AiOutlineMail />
                    </a>
                    <a
                        href="https://www.linkedin.com/in/jerison-feliz/"
                        target="_blank"
                        rel="noopener noreferrer"
                    >
                        <AiFillLinkedin />
                ...
                <div className="rifflene">
                    ...
                    <a href="mailto:raltidor@falcon.bentley.edu">
                        <AiOutlineMail />
                    </a>
                    <a
                        href="https://www.linkedin.com/in/rifflene-altidor-23ba6520b/"
                        target="_blank"
                        rel="noopener noreferrer"
                    >
                        <AiFillLinkedin />
